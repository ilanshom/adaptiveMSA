...
input_directory =  '/home/mazooji2/UPP-datasets/' #'16S/'
...
datas  = ["16S.B.ALL", "16S.T", "16S.3"]
#datas  = ["16S.T", "16S.3"]

for data in datas:

    reference_file = input_directory + data + '/R0/cleaned.alignment.TtoU.fasta'
...
#    /home/mazooji2/UPP-datasets-runs/16S/16S.B.ALL-rna-UPP2-early_stop-x24
    ...
    output_subdirectory = output_directory + data + "-rna-UPP2-early_stop-x" + str(processors) + "/"
