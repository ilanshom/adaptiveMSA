...
for data in datas:
    for sample in samples:
        ...
        os.system("script -c  \"run_upp.py -A 10 -B " +  str(backbone) + " -M -1 -m dna -s " + data_file +  " -d " + output_subdirectory + " -x " +  str(processors) + " \" " + output_subdirectory + "terminal_output.txt")
