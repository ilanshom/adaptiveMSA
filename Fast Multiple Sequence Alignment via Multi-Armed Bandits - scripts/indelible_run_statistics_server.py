...
datas = ["10000M2", "10000M3", "10000M4"] #, "10000M4"]
#datas = ["10000M4"]
samples = ['0']
...
for data in datas:
    for sample in samples:
        ...
        reference_file = input_directory + data + '/' + sample + '/model/true.fasta'
    ...
    #    /home/mazooji2/UPP-datasets-runs/16S/16S.B.ALL-rna-UPP2-early_stop-x24
        ...
        output_subdirectory = output_directory + data  + "-" + sample +  "-UPP2-early_stop-x" + str(processors) + "/"
        ...
        output_subdirectory = output_directory + data + "-" + sample + "-fp5-B" + str(backbone) + "-K" + str(K) + "-ktc" + str(ktc) + "-stc" + str(stc) + "-srnds" + str(rounds) + "-x" + str(processors) + "/"
